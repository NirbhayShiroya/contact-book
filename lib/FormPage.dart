...
// Common Allow Character ( ! @ # \$ & * ~ )""";
  ...
  List<String> contryPhcode = ["+91", "+1", "+44", "+52", "+86"];
                  ...
                  onPressed: () async {
                    ...
                    // }
                      ...
                      String strhobby = lsthobby.join(
                          ","); //convert list to string for store in string in database
                      String qry =
                          "insert into contactinfo (fname,mname,lname,email,phonecode,mno,address,city,gender,hobby) values ('$fname','$mname','$lname','$email','$phcode','$contactno','$address','$city','$gender','$strhobby')";
